...
option_menu1 = OptionMenu(frame_form, country_var1, "Россия", "Русь", "СССР", "Российская Империя")
...
text_widget.grid(row=7, column=1, padx=10, pady=5, sticky='w', columnspan=3)
text_widget.insert("1.0", placeholder)
text_widget.config(fg='grey')
...
btn1 = Button(frame_form, text="Отменить ввод", command=cencel_form)
